var skyImagePath = "./images/thunderHigh.png";
var wallLeftPath = "./images/wallleft.jpg";
var wallRightPath = "./images/wallright.jpg";
var wallFrontPath = "./images/wallfront.jpg";
var ceilingPath = "./images/wallTop.jpg";
var boxesDownImagePath = "./images/thunder.png";
var floorImagePaths = ['./images/disturb_dxt1_nomip.dds', './images/Mountains.dds'];
...
function init() {
    ...
    //camera.position.set(0, atHeight, 0);
   ...
   // controls.getObject().translateY(atHeight);
    ...
    var loader  = new THREE.TextureLoader(),
        texture1 = loader.load(skyImagePath);
    ...
    var map1 = loaderFloor.load( floorImagePaths[0]);
    map1.minFilter = map1.magFilter = THREE.LinearFilter;
    map1.anisotropy = 4;

    var cubemap1 = loaderFloor.load( floorImagePaths[1], function ( texture ) {
    ...
    var loader  = new THREE.TextureLoader(),
        wallLeftTexture = loader.load(wallLeftPath),
        wallRightTexture = loader.load(wallRightPath),
        wallFrontTexture = loader.load(wallFrontPath),
        ceilingTexture = loader.load(ceilingPath),
        boxTexture = loader.load(boxesDownImagePath);

    // Wall material
    var wallLeftMaterial = new THREE.MeshLambertMaterial({
        map: wallLeftTexture,
    });
    ...
    var wallFrontMaterial = new THREE.MeshLambertMaterial({
        map: wallFrontTexture,
    });
    var wallFrontGeo = new THREE.PlaneGeometry( 500, 500, 100, 100 );
    wallFrontGeo.rotateY( Math.PI);

    var wallFront = new THREE.Mesh( wallFrontGeo, wallFrontMaterial);
    wallFront.position.set(0, 250, 250);
    scene.add(wallFront);

    var wallRightMaterial = new THREE.MeshLambertMaterial({
        map: wallRightTexture,
    });

    var wallRightGeo = new THREE.PlaneGeometry( 1000, 700, 100, 100 );
