var skyImagePath = "./images/textureCrazy.png";
var wallsImagePath = "./images/walls2.jpg";
var boxesDownImagePath = "./images/roots.png";
var boxesUpImagePath = "./images/thunder.png";
...
function init() {
    ...
    var loader  = new THREE.TextureLoader(),
        wallTexture = loader.load(wallsImagePath),
        boxDown = loader.load(boxesDownImagePath),
        boxUp = loader.load(boxesUpImagePath);
    ...
    var wallLeftGeo = new THREE.PlaneGeometry( 1000, 1000, 100, 100 );
    wallLeftGeo.rotateY( Math.PI / 2 );

    var wallLeft = new THREE.Mesh( wallLeftGeo, wallMaterial);
    wallLeft.position.set(-250, 100, 0);
    scene.add(wallLeft);


    var wallRightGeo = new THREE.PlaneGeometry(1000, 1000, 100, 100 );
    wallRightGeo.rotateY(- Math.PI / 2);

    var wallRight = new THREE.Mesh( wallRightGeo, wallMaterial);
    wallRight.position.set(250, 100, 0);
    scene.add( wallRight);

    var ceilingGeo = new THREE.PlaneGeometry(1000, 500, 100, 100 );
    ...
    var boxDownMaterial = new THREE.MeshLambertMaterial({
        map: boxDown,
    });

    var boxUpMaterial = new THREE.MeshLambertMaterial({
        map: boxUp,
    });
    ...
    for ( var i = 0; i < 4000; i +=20 ) {
        ...
        for(var j = 0; j < 500; j += 20){
            ...
            var box = new THREE.Mesh(boxGeometry, boxUpMaterial);
    ...
    for ( var i = 0; i > -1000; i -=20 ) {
        for (var j = 0; j < 500; j += 20) {
            ...
            var box = new THREE.Mesh(boxGeometry, boxDownMaterial);
            box.position.set(-250 + j + 10, i - 10, -250 + i - 10);
            box.castShadow = true;
            scene.add(box);
            objects.push(box);
...
function animate() {
    ...
    if ( controlsEnabled === true ) {
        ...
        if ( onObject === true ) {
            ...
            window.location.href = "http://i6.cims.nyu.edu/~rds493/drawing/final/future/";
